...
def run_camera():
    # Load the network
    net = cv2.dnn.readNet('config/ssd_inception_v2_coco_2018_01_28/frozen_inference_graph.pb', 'config/ssd_inception_v2_coco_2018_01_28/ssd_inception_v2_coco_2018_01_28.pbtxt')
    classes = []
